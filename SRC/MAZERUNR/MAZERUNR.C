...
unsigned char tile6[] = {  0x77, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                           ...
                           0x78, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                           0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77,
                           0x77, 0x88, 0x88, 0x78, 0x87, 0x88, 0x88, 0x78};
...
unsigned char tileB[] = {  0x77, 0x88, 0x88, 0x78, 0x87, 0x88, 0x88, 0x77,
                           ...
                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x87,
                           0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77,
                           0x87, 0x88, 0x88, 0x78, 0x87, 0x88, 0x88, 0x77};
...
int main(int argc, char **argv)
{
    ...
    while (!kbhit())
    {
        ...
        while (frameCount < 60)
        {
             ...
             */
            if ((faceS >= ((BORDER_RIGHT << 4) - FACE_WIDTH - 2))   || (faceS < 2)) incS = -incS;
            if ((faceT >= ((BORDER_BOTTOM << 4) - FACE_HEIGHT - 2)) || (faceT < 2)) incT = -incT;
